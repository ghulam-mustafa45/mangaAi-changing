...
>
  ...
  <div className="carousel-slide " >
    ...
    <div className='bg-gray-800 rounded-lg  pl-5 justify-center relative z-10 w-fit p-4 '>
                    ...
                    <p className='text-white w-64 m-auto text-justify pb-5 font-custom4 text-xs'>
                    ...
                    <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex m-auto lg:mt-4 mt-3 ">Generate Anime Art </button>
                </div>
  ...
  <div className="carousel-slide">
    ...
    <div className='bg-gray-800 rounded-lg  pl-5 justify-center float-left  ml-5 relative z-10 w-fit p-4'>
                    ...
                    <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex  lg:mt-4 mt-3 m-auto mb-2">Generate Anime Art </button>
                </div>
  </div>
  ...
  <div className="carousel-slide">
    ...
    <div className='bg-gray-800 rounded-lg  pl-5 justify-center ml-5 relative z-10 w-fit p-4'>
                    ...
                    <p className='text-white w-64 m-auto text-justify pb-4 font-custom4 text-xs'>
                    ...
                    <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2  flex lg:mt-4 mt-3 m-auto">Generate Anime Art </button>
                </div>
  </div> 
</Carousel>
</div>
  ...
  <h2 className=' pt-16 lg:pt-32 m-auto text-left w-fit lg:text-left pb-5' >
    ...
    <div className='flex pb-16 text-xs lg:text-base' >
        ...
        <div className='lg:ml-20 ml-2 w-fit pl-2 p-2'>
            ...
            <p className='text-white lg:w-[60%] w-[88%]  text-justify'>Introducing the Manga AI Membership NFT, your ticket to a world filled with exclusive utilities within the Manga AI ecosystem. This pass doesn't just give you instant access to utilities that are available now  – it's your key to a future filled with even more possibilities.</p>
        ...
        <div className='lg:bg-gray-900 w-fit rounded-lg lg:pt-7 pt-24 pb-3 mr-2'>
              <div className='lg:pl-7 pl-3'>
                    <h4 className='text-sm lg:text-lg'>
                      ...
                      <p className='text-white w-[100%] lg:text-w-[80%] text-justify pt-2 pb-3'>
