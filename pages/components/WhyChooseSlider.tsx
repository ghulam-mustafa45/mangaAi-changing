...
const WhyChooseSlider = () => {
  return (
    <div className='bg-gray-950 relative md:hidden'>
    ...
    <img className="absolute sm:relative w-full h-fit" src="./images/divq1.svg" alt="error" />
...
<div className='w-full'>
  <h2 className=' pt-16 sm:pt-32 m-auto text-left w-fit sm:text-left pb-5' >
            <span
            className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text 'containor'>
            <div className='bg-gray-800 rounded-lg sm:w-1/3  pl-5 justify-center relative z-10"
    ...
    <div className='flex pb-16 text-xs sm:text-base' >
        ...
        <div className='sm:ml-20 ml-2 w-fit pl-2 p-2'>
            ...
            <p className='text-white sm:w-[60%] w-[88%]  text-justify'>Introducing the Manga AI Membership NFT, your ticket to a world filled with exclusive utilities within the Manga AI ecosystem. This pass doesn't just give you instant access to utilities that are available now  – it's your key to a future filled with even more possibilities.</p>
        ...
        <div className='sm:bg-gray-900 w-fit rounded-lg sm:pt-7 pt-24 pb-3 mr-2'>
              <div className='sm:pl-7 pl-3'>
                    <h4 className='text-sm sm:text-lg'>
                      <span
                      className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text 'containor '>
                      <div className='bg-gray-800 rounded-lg sm:w-1/3 pl-5 justify-center relative z-10 "
                      ...
                      <p className='text-white w-[100%] sm:text-w-[80%] text-justify pt-2 pb-3'>
