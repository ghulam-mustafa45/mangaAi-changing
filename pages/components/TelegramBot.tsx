...
<div className='bg-purple-950 pb-40'>
          ...
          <p className=' w-fit m-auto pt-24 text-center font-bold sm:text-5xl  text-2xl' >
                ...
                <p className='text-white text-center m-auto sm:text-base text-xs w-72 sm:w-full'>Make fantastic anime artwork in just seconds with Manga AI's Ai Bot</p>
                
                <div className='flex '>
                    <div className=' items-center  sm:w-96 relative sm:pl-8  mr-1'>
                            <div >
                              <img className='w-32 sm:w-44 h-auto' src="./images/divs2.svg" alt="error" />
                            </div>                             
                    </div>
                  ...
                  <div className='bg-purple-800  rounded-3xl p-2 h-fit mt-[8%] flex w-48 sm:w-[40%] '>
                    <div className='m-auto flex sm:space-x-40 text-xs sm:text-lg space-x-12 '>
                        ...
                        <div className='text-white text-center leading-3 '>
                  ...
                  <div className=' items-center  sm:w-96 relative sm:pl-[7%] ml-1 mr-1'>
                            <div >
                              <img className=' w-28 sm:w-40 h-auto' src="./images/divs3.svg" alt="error" />
                            </div> 
                    </div>

               </div>

               <img className='w-[40%] ml-[30%] auto absolute' src="./images/divs4.svg" alt="error" />
