...
<div className='bg-gray-950 relative hidden sm:block'>
        ...
        <img className="absolute inset-0 w-full h-fit" src="./images/divq1.svg" alt="error" />


          <div className='flex left-0 w-full h-full  items-center justify-center pt-24 pb-24' id='containor'>
                <div className='bg-gray-800 rounded-lg  pl-5 justify-center relative z-10 w-fit p-4 '>
                    ...
                    <p className='text-white w-64 m-auto text-justify pb-5'>
                    ...
                    <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex m-auto sm:mt-4 mt-3 ">Generate Anime Art </button>
                </div>
                ...
                <div className='bg-gray-800 rounded-lg  pl-5 justify-center float-left  ml-5 relative z-10 w-fit p-4'>
                    ...
                    <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex  sm:mt-4 mt-3 m-auto mb-2">Generate Anime Art </button>
                </div>

                <div className='bg-gray-800 rounded-lg  pl-5 justify-center ml-5 relative z-10 w-fit p-4'>
                    <h1 className='text-green-500 justify-center sm:text-lg text-lg w-20 m-auto text-center pb-4'>
                    Elevate Quality
                    </h1>
                    <p className='text-white w-64 m-auto text-justify pb-4'>
                    ...
                    <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2  flex sm:mt-4 mt-3 m-auto">Generate Anime Art </button>
                </div>
  ...
  <h2 className=' pt-20 sm:pt-32 m-auto text-left w-fit sm:text-left pb-5' >
            <span
            className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text 'containor'>
            <div className='bg-gray-800 rounded-lg sm:w-1/3  pl-5 justify-center relative z-10"
    ...
    <div className='flex pb-16 text-xs sm:text-base' >
      
        <div className='sm:ml-20 ml-2 w-fit'>
            <h4 className='text-sm sm:text-lg'>
            <span
            className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text 'containor'>
            <div className='bg-gray-800 rounded-lg sm:w-1/3 sm:pl-5 justify-center relative z-10"
            style={{ backgroundImage: 'linear-gradient(to right, #8B008B, #8B5CF6, #00FF00)',}}> Unlock Special Utilities
            </span>
            </h4>
            <p className='text-white sm:w-[60%] w-[78%]  text-justify'>Introducing the Manga AI Membership NFT, your ticket to a world filled with exclusive utilities within the Manga AI ecosystem. This pass doesn't just give you instant access to utilities that are available now  – it's your key to a future filled with even more possibilities.</p>
            <div className='border-1 h-7 border-purple-500 rounded-full inline-block mb-2 mr-3 ml-1  float-left'></div>
            <a className='text-white' href="/">Discover More</a>
        </div>

        <div className='bg-gray-900 w-fit rounded-lg pt-7 pb-3'>
              <div className='sm:pl-7 pl-5'>
                    <h4 className='text-sm sm:text-lg'>
                      ...
                      <p className='text-white w-[93%] sm:text-w-[80%] text-justify pt-2 pb-3'>
