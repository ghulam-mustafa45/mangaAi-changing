...
const WhyChoose = () => {
  return (
    <>
      <div className="bg-main-gray relative hidden sm:block">
        ...
        >
          <div className="bg-gray-800 rounded-lg  pl-5 justify-center relative z-10 w-fit p-4 ">
            ...
            <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex m-auto sm:mt-4 mt-3 ">
              Generate Anime Art{" "}
            </button>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg  pl-5 justify-center float-left  ml-5 relative z-10 w-fit p-4">
            ...
            <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex  sm:mt-4 mt-3 m-auto mb-2">
              Generate Anime Art{" "}
            </button>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg  pl-5 justify-center ml-5 relative z-10 w-fit p-4">
            ...
            <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2  flex sm:mt-4 mt-3 m-auto">
              Generate Anime Art{" "}
            </button>
          </div>
        </div>
        ...
        <div className="w-full pt-56">
          <div className="flex pb-16 text-xs sm:text-base">
            <div className="sm:ml-20 ml-2 w-fit">
              <h2 className=" text-left  sm:text-left mb-4">
                <span
                  className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text 'containor'>
            <div className='bg-gray-800 rounded-lg sm:w-1/3  justify-center relative z-10"
              ...
              <h4 className="text-sm sm:text-lg mb-5">
                <span
                  className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text 'containor'>
            <div className='bg-gray-800 rounded-lg sm:w-1/3  justify-center relative z-10"
                  style={{
              ...
              <p className="text-white sm:w-[60%] w-[78%]  text-left">
