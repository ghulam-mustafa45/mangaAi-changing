      ...
      >
        ...
        <div className="flex px-10 w-full">
          <div
            ...
            <p className="text-white pb-4 lg:text-base text-xs w-48">MANGA token holders have the opportunity to actively engage with the platform's growth through staking.
            </p>
            <button className="rounded-md text-white mb-4 bg-gradient-to-r from-purple-600 to-green-500 p-2 font-medium flex justify-center m-auto lg:mt-4 mt-3 w-44">
              Stake
            </button>
          </div>
          ...
          <div className="flex flex-col ml-2 ">
            ...
            >
              ...
              <p className="text-white pt-2 lg:text-base text-xs text-justify ">
