        ...
        <div className='flex'>
                <div className='bg-gray-800 w-fit rounded-lg lg:p-9 p-3 mt-12  lg:ml-[8%] ml-2'>
                  <div className='flex'>
                      ...
                      <p className='text-white lg:w-72 w-44 text-justify pt-1 pb-1 lg:text-base text-xs'>You can transfer your tokens across your wallets without any payment.</p>
                      ...
                      <p className='text-white lg:w-72 w-44 text-justify pt-1 pb-1 lg:text-base text-xs'>Purchase $Manga with 4% tx - 2% to marketing, 1% to Ecosystem,  1% to lp</p>
                      <div className='border-1 w-[90%] border-white rounded-full inline-block mb-2 mr-2  m-auto  '></div>

                      <div className='flex'>
                      <h4 className='text-[#A075B4]  lg:text-2xl text-base pt-1 font-custom8'>Sell Tax</h4>
                      <div className='bg-gray-600 text-[#A7FFAA] rounded-xl w-14 text-center p-2 ml-14 lg:ml-28 font-custom8 lg:text-base text-sm'>4%</div></div>
                      <p className='text-white lg:w-72 w-44 text-justify pt-1 pb-1 lg:text-base text-xs'>Sell $Manga with 4% tx - 2% to marketing, 1% to Ecosystem,  1% to lp</p>
                 </div>
