        ...
        <div className="flex w-full gap-x-2">
          <div className="flex flex-col gap-y-2 ">
            <div className="bg-main-gray-lighter rounded-lg p-2">
              ...
              <button className="rounded-md text-white mb-4 bg-gradient-to-r from-purple-600 to-green-500  p-2 font-medium flex justify-center m-auto lg:mt-4 mt-3 text-sm">
                Stake
              </button>
            </div>
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="bg-main-gray-lighter rounded-lg p-2">
              ...
              <a className="text-white text-xs lg:text-base ml-2" href="/">Mint Now</a>
            </div>
          </div>
        </div>
      </div>
