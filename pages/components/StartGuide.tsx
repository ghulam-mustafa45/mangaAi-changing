...
<div>
  <div className='lg:mt-16 mt-4 '>
    <div className='flex'>
            ...
            <p className='text-white lg:w-64 w-40 lg:text-base text-xs'>Set up a MetaMask Wallet on your desktop computer or iOS/Android mobile device. This will enable you to easily buy, sell, send, and receive $Manga tokens.</p>
            </div>
            ...
            <p className='text-white lg:w-64 w-40 lg:text-base text-xs'>Once you have BNB in your wallet, you can immediately begin swapping. Click on 'Select a token' and either input the token address or locate it in the tokens list.</p>         
            </div>
       </div>
       ...
       <div className='flex mt-7'>
                ...
                <p className='text-white lg:w-64 w-40 lg:text-base text-xs'>Purchase BNB directly within MetaMask or transfer it from exchanges like Coinbase, Binance, and more to your MetaMask Wallet.</p>         
                </div>
