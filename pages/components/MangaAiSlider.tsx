...
const MangaAiSlider = () => {
  return (
    ...
    <p  className='  m-auto text-white lg:w-[59%] lg:text-base text-xs mt-2 p-3'>At Manga AI, we highly value the contributions of our users. In pursuit of this, we're excited to introduce Manga AI Points – a dynamic system that rewards the creativity and active participation of our MANGA AI Bot users</p>
