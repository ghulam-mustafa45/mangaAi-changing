...
const MangaAiSlider = () => {
  return (
    <div className='bg-gray-950 sm:pb-28 pb-14 relative md:hidden'>
    ...
    <p  className='  m-auto text-white sm:w-[59%] sm:text-base text-xs mt-2 p-3'>At Manga AI, we highly value the contributions of our users. In pursuit of this, we're excited to introduce Manga AI Points – a dynamic system that rewards the creativity and active participation of our MANGA AI Bot users</p>
...
>
  ...
  <div className="carousel-slide">
    ...
    <div className='bg-gray-800 rounded-lg  pl-5 justify-center ml-5 relative z-10 w-fit p-4'>
                    <h1 className='text-green-500 justify-center sm:text-lg text-lg w-40 m-auto text-center pb-4'>
