...
<div className='bg-main-gray pb-14 font-Lato'>
    <h1 className=' w-fit m-auto pt-5' >
            ...
            <p  className='  m-auto text-white lg:w-[46%] w-[75%] text-center mt-3 mb-5 lg:text-base text-xs'>Here are beautiful anime images and captivating animated artworks, all created by our skilled community using our AI technology.</p>
            <div className='w-fit  mb-12'>
                 <img className='w-[75%]  m-auto' src="./images/divu1.svg" alt="error" />
            </div>

            <button className="rounded-md text-white bg-gradient-to-r from-purple-500 to-green-500 p-2 flex m-auto lg:mt-4 mt-3 pt-3">Create Your Anime Art Now <p className='ml-6 mt-1'><FaArrowRight/></p></button>
